...
const hasForcePendingActiveMatch = (router) => {
...
const shouldSkipLoader = (inner, matchId) => {
	...
	if (!(false ?? inner.router.isServer) && match._nonReactive.dehydrated) return true;
	if ((false ?? inner.router.isServer) && match.ssr === false) return true;
	return false;
};
...
const setupPendingTimeout = (inner, matchId, route, match) => {
	...
	if (!!(inner.onReady && !(false ?? inner.router.isServer) && !resolvePreload(inner, matchId) && (route.options.loader || route.options.beforeLoad || routeNeedsPreload(route)) && typeof pendingMs === "number" && pendingMs !== Infinity && (route.options.pendingComponent ?? inner.router.options?.defaultPendingComponent))) {
...
const handleBeforeLoad = (inner, index) => {
	...
	const route = inner.router.looseRoutesById[routeId];
	const serverSsr = () => {
		if (false ?? inner.router.isServer) {
...
const runLoader = async (inner, matchPromises, matchId, index, route) => {
	try {
		const match = inner.router.getMatch(matchId);
		try {
			if (!(false ?? inner.router.isServer) || match.ssr === true) loadRouteChunk(route);
...
const loadRouteMatch = async (inner, matchPromises, index) => {
	...
	if (shouldSkipLoader(inner, matchId)) {
		...
		if (false ?? inner.router.isServer) return inner.router.getMatch(matchId);
	} else {
...
async function loadMatches(arg) {
	const inner = arg;
	const matchPromises = [];
	if (!(false ?? inner.router.isServer) && hasForcePendingActiveMatch(inner.router)) triggerOnReady(inner);
			...
			loadPromise = new Promise((resolve) => {
				this.startTransition(async () => {
					try {
						...
						if (isRedirect(err)) {
							redirect = err;
							if (!(false ?? this.isServer)) this.navigate({
								...redirect.options,
								replace: true,
								ignoreBlocker: true
							});
...
function useLinkProps(options, forwardedRef) {
	...
	const _isServer = false ?? router.isServer;
...
function MatchView({ router, matchId, resetKey, matchState }) {
	...
	}), matchState.parentRouteId === "__root__" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnRendered, {}), router.options.scrollRestoration && (false ?? router.isServer) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollRestoration, {}) : null] }) : null] });
}
function OnRendered() {
	const router = useRouter();
	if (false ?? router.isServer) return null;
...
function Matches() {
	...
	const pendingElement = PendingComponent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PendingComponent, {}) : null;
	const inner = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)((false ?? router.isServer) || typeof document !== "undefined" && router.ssr ? SafeFragment : import_react.Suspense, {
		fallback: pendingElement,
		children: [!(false ?? router.isServer) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Transitioner, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MatchesInner, {})]
	});
...
//#endregion
//#region ../app/integrations/[slug]/layout.tsx
var import_client = require_client();
function IntegrationLayout({ children }) {
	const parts = useRouterState({ select: (state) => state.location.pathname }).split("/").filter(Boolean);
	const slug = parts[1] ?? "tmo";
	const current = parts[2] ?? "overview";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "sticky top-14 z-30 border-b bg-background/95 px-4 backdrop-blur lg:top-0 lg:px-8",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
			...
			children: [
				...
				[
					"loans",
					"Loans",
					`/integrations/${slug}/loans`
				],
				[
					"payments",
					"Payments",
					`/integrations/${slug}/payments`
				],
				[
					"sync",
					"Sync",
				...
				[
					"debug",
					"Debug",
					`/integrations/${slug}/debug`
				]
			].map(([key, label, href]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
				href,
				className: cn("rounded-md px-3 py-2 text-sm font-medium text-muted-foreground hover:bg-muted hover:text-foreground", current === key && "bg-accent text-accent-foreground"),
				children: label
			}, key))
		})
	}), children] });
...
//#endregion
//#region ../target/debug/build/trust-deeds-nextrs-fb9456eea4efeb5d/out/nextrs_tsx/__app_shell__.tsx
...
function nxLeaf(load) {
	...
	return function NxPage() {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lazy, { params });
	};
}
...
const layout_0 = createRoute({
	getParentRoute: () => rootRoute,
	id: "index",
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layout, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}) })
});
const layout_1 = createRoute({
	getParentRoute: () => layout_0,
	id: "integrations-_slug_",
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IntegrationLayout, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}) })
});
const route_0 = createRoute({
	getParentRoute: () => layout_0,
	path: "/",
	component: nxLeaf(() => import("./index-EocDuFWF.js"))
});
const route_1 = createRoute({
	getParentRoute: () => layout_0,
	path: "/canvas",
	component: nxLeaf(() => import("./canvas-Dssa3KEs.js"))
});
const route_2 = createRoute({
	getParentRoute: () => layout_0,
	path: "/forecast",
	component: nxLeaf(() => import("./forecast-CS8WaPLN.js"))
});
const route_3 = createRoute({
	getParentRoute: () => layout_0,
	path: "/inbox",
	component: nxLeaf(() => import("./inbox-C4hlTQDA.js"))
});
const route_4 = createRoute({
	getParentRoute: () => layout_0,
	path: "/inbox/$email_id",
	component: nxLeaf(() => import("./inbox-_email_id_-emkRqM1u.js"))
});
const route_5 = createRoute({
	getParentRoute: () => layout_0,
	path: "/integrations",
	component: nxLeaf(() => import("./integrations-D79B0Q9M.js"))
});
const route_6 = createRoute({
	getParentRoute: () => layout_1,
	path: "/integrations/$slug",
	component: nxLeaf(() => import("./integrations-_slug_-BU7G_QrC.js"))
});
const route_7 = createRoute({
	getParentRoute: () => layout_1,
	path: "/integrations/$slug/debug",
	component: nxLeaf(() => import("./integrations-_slug_-debug-Dvlj-eYm.js"))
});
const route_8 = createRoute({
	getParentRoute: () => layout_1,
	path: "/integrations/$slug/loans",
	component: nxLeaf(() => import("./integrations-_slug_-loans-D0h2JVTp.js"))
});
const route_9 = createRoute({
	getParentRoute: () => layout_1,
	path: "/integrations/$slug/loans/$loan_account",
	component: nxLeaf(() => import("./integrations-_slug_-loans-_loan_account_-DQheiSaS.js"))
});
const route_10 = createRoute({
	getParentRoute: () => layout_1,
	path: "/integrations/$slug/payments",
	component: nxLeaf(() => import("./integrations-_slug_-payments-Dcagj1NH.js"))
});
const route_11 = createRoute({
	getParentRoute: () => layout_1,
	path: "/integrations/$slug/sync",
	component: nxLeaf(() => import("./integrations-_slug_-sync-3Fr48bd7.js"))
});
const route_12 = createRoute({
	getParentRoute: () => layout_0,
	path: "/login",
	component: nxLeaf(() => import("./login-BBwLUVIe.js"))
});
const route_13 = createRoute({
	getParentRoute: () => layout_0,
	path: "/streams",
	component: nxLeaf(() => import("./streams-Cwjk4uc4.js"))
});
const router = createRouter({
	routeTree: rootRoute.addChildren([layout_0.addChildren([
		layout_1.addChildren([
			route_6,
			route_7,
			route_8,
			route_9,
...
Object.assign(window, { __nx_router__: router });
const NX_APP_ROUTES = [
	/^\/$/,
	/^\/canvas$/,
	/^\/forecast$/,
...
(0, import_client.createRoot)(document.getElementById("__nx_root__")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RouterProvider, { router }));
