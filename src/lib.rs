...
pub mod app;
pub use app::{configured_router, init_tracing};
#[cfg(feature = "local-db")]
pub use app::bootstrap_local_from_env;

// build.rs generates this registry from app/; the seed companions it emits
// resolve modules against the crate root, so the include! must stay here.
...
mod tests {
    ...
    use super::{
        app::{bootstrap_local_context, router_with_store},
